...
O **Guia+** é um sistema desenvolvido para **reduzir o absenteísmo em
consultas médicas**, ajudando principalmente pessoas que enfrentam
dificuldades no uso de tecnologias, seja por **idade, deficiência ou
baixa familiaridade com ferramentas digitais**.

A plataforma oferece funcionalidades como lembretes de consultas, guia
simples para teleconsultas, suporte, acessibilidade e tutoriais,
garantindo que os pacientes consigam utilizar os serviços do hospital de
forma prática e sem barreiras.
